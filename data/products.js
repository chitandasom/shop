...
const products = [
...

  {
    ...
    description1: "원하는 대상을 증명 그림으로 만들어 드립니다.<br>구매 후, 주문자명과 함께 증명 그림으로 제작할 사진을<br>chitandasom@gmail.com로 보내주세요.",
    description2: "Custom ID portraits of your chosen subject.<br>After purchase, please email photo(s) of the subject<br>for the custom ID portrait, along with the buyer’s name.",
